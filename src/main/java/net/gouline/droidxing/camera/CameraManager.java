...
import net.gouline.droidxing.camera.open.OpenCameraInterface;
...
public final class CameraManager {
   ...
   */
  public synchronized void openDriver(SurfaceHolder holder, int screenRotation) throws IOException {
    Camera theCamera = camera;
    if (theCamera == null) {
      theCamera = OpenCameraInterface.open(screenRotation);
