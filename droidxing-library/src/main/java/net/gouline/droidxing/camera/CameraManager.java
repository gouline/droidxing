...
import net.gouline.droidxing.camera.open.OpenCameraManager;
...
public final class CameraManager {
     ...
     *
     * @param activity The capture activity.
     ...
     */
    private synchronized void setCameraDisplayOrientation(Activity activity, int cameraId, android.hardware.Camera camera) {
        android.hardware.Camera.CameraInfo info = new android.hardware.Camera.CameraInfo();
        android.hardware.Camera.getCameraInfo(cameraId, info);
        cameraRotation = activity.getWindowManager().getDefaultDisplay().getRotation();
        int degrees = 0;
     ...
     */
    public synchronized Rect getFramingRectInPreview(boolean landscape) {
     ...
     *
     * @return Camera orientation integer corresponding to {@link android.view.Surface}.
     */
